...
const SignIn: React.FC = () => {
  ...
  const handleSignin = async (e: React.FormEvent) => {
    ...
    if (!password || password.trim() === '') {
      setPasswordError('Silakan masukkan kata sandi Anda');
    ...
    if (!hasError) {
      try {
        ...
        const response = await fetch(
          `${import.meta.env.VITE_APP_PUBLIC_API_URL}/auth/login`,
          {
            method: 'POST',
        ...
        if (response.ok) {
          ...
          if (userRole === 'admin') {
            ...
            setPasswordError('Peran tidak dikenali. Silakan hubungi dukungan');
          }
        } else {
          setPasswordError(result.message || 'Email atau kata sandi salah');
        }
      } catch (error) {
        ...
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-10 text-center">
            ...
            <p className="2xl:px-20">
              Selamat datang kembali di Halo Kreasi Nusantara. Silakan Masuk.
            </p>
