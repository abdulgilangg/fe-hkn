    ...
    if (!hasError) {
      try {
        ...
        if (response.ok) {
          ...
          setPasswordError(result.message || 'Incorrect email or password');
          setLoading(false);
        }
      } catch (error) {
      ...
      {showNotification && (
        <div className="fixed left-1/2 top-0 mt-5 flex w-100 -translate-x-1/2 transform items-center justify-between rounded bg-green-500 p-4 shadow-sm">
          <div className="flex items-center">
            ...
            <p className="ml-3 font-medium text-white">SignIn Successfully</p>
          </div>
          <button
            type="button"
        ...
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-10 text-center">
            ...
            <p className="2xl:px-20">
              Welcome back to Halo Kreasi Nusantara. Please Sign In.
            </p>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary ${
                      emailError ? 'border-red-600 text-black' : 'text-blue-600'
                    }`}
                  />
                  {emailError && (
              ...
              <div className="mb-4">
                <div className="mb-2.5 flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="block font-medium text-primary dark:text-white"
                  >
                    Forgot password?
                  </Link>
                </div>
