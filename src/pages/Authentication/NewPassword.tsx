    ...
    if (!hasError) {
      try {
        ...
        const response = await fetch(
          `${import.meta.env.VITE_APP_PUBLIC_API_URL}/auth/new-password`,
          {
            method: 'POST',
        ...
        if (response.ok) {
          ...
          setPasswordError(result.message || 'Kata sandi salah');
        }
      } catch (error) {
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              <p className="2xl:px-20">
                Selamat datang kembali di Halo Kreasi Nusantara. Silakan
