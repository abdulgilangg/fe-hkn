...
const DataTransaksi: React.FC = () => {
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <table className="w-full table-auto !border-collapse overflow-hidden break-words px-4 md:table-fixed md:overflow-auto md:px-8">
        <thead>
          <tr role="row">
            ...
            >
              <div className="grid grid-cols-9 border-stroke bg-gray-2 px-4 py-4.5 dark:border-strokedark dark:bg-meta-4 sm:grid-cols-9 md:px-5 2xl:px-7.5">
                ...
                <div className="col-span-1 flex items-center justify-center">
                  <p className="font-medium">Export PDF/Excel</p>
                  <div className="ml-2 inline-flex flex-col space-y-[2px]">
                    <span className="inline-block">
                      <svg
                        className="fill-current"
      ...
      {currentEntries.map((historiPesanan, key) => (
        <div
          className="grid grid-cols-9 border-t border-stroke px-4 py-4.5 dark:border-strokedark sm:grid-cols-9 md:px-5 2xl:px-7.5"
          key={key}
        >
          <div className="col-span-1 flex items-center justify-center">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              <p className="text-sm text-black dark:text-white">
                {historiPesanan.tanggal}
              </p>
            </div>
          </div>
          <div className="col-span-1 hidden items-center justify-center sm:flex">
            <p className="text-sm text-black dark:text-white">
              {historiPesanan.noOrder}
            </p>
          </div>
          <div className="col-span-1 flex items-center justify-center">
            <p className="text-sm text-black dark:text-white">
              {historiPesanan.jumlah}
            </p>
          </div>
          <div className="col-span-1 flex items-center justify-center">
            <p className="text-sm text-black dark:text-white">
              {historiPesanan.jenisPayment}
            </p>
          </div>
          <div className="col-span-1 flex items-center justify-center">
            <p className="text-sm text-black dark:text-white">
