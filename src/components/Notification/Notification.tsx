...
const Notification = () => {
  ...
  // Jika notifikasi tidak terlihat, jangan render apa-apa
  if (!isVisible) {
    return null;
  }

  return (
    <div className="max-w-auto mb-5 rounded-md border border-[#F5C5BB] bg-[#FCEDEA] py-4 pl-4 pr-5.5 shadow-2 dark:border-[#EA4E2C] dark:bg-[#1B1B24]">
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={handleClose}
          className="flex h-7 w-7 items-center justify-center rounded-md bg-white text-[#637381] hover:text-black dark:bg-meta-4 dark:hover:text-white"
        >
          <svg
